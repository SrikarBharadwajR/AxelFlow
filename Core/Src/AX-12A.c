 ...
 */
#include "/mnt/Storage/Projects/STM32/AxelFlow/Core/Inc/AX-12A.h"
#include "stdint.h"
#include "stdio.h"
...
uint8_t getChecksum(struct Instruction_Packet packet)
{
...
bool checkChecksum(struct Instruction_Packet packet)
{
...
bool transmitToServo(struct Instruction_Packet packet)
{
...
//uint8_t *ping(uint8_t model_number)
//{
//
//}
